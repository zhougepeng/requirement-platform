...
从包含自动更新助手的安装包开始，管理员可在左下角菜单选择“检查更新”。系统会比较当前安装包版本与 GitHub Release 的最新版本；发现新版后，点击“下载并更新”即可由服务器后台下载、安装、重启并执行原有健康检查与失败回滚。更新状态会保存在安装目录中，服务重启后页面会继续显示“进行中”、成功或失败结果。
